...
function Footer() {
  return (
    <div className="footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center">
      ...
      <p className="text-white pb-[13px] opacity-70 leading-7">We always make our seekers and companies find the best jobs and employers fond the best candidates.</p>
      </div>
      <div className="grid">
      ...
      <div className="grid">
        ...
        <div className="text-[14px] text-white">
          <small>WahyuMustikaAji@gmail.com</small>
          <div className="icons flex gap-4 py-[1rem] items-center">
